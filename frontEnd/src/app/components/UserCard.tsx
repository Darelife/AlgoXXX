...
const UserCard: React.FC<UserCardProps> = React.memo(({ user, userRank, contestDelta }) => {
  ...
  return (
    <Card key={user.bitsid} className="dark:border-none overflow-hidden transition-all duration-300 hover:shadow-lg relative">
      <div className="bg-gradient-to-br from-white to-blue-50/60 dark:bg-gradient-to-br dark:from-gray-800/20 dark:to-gray-900/10 backdrop-blur-sm rounded-xl shadow-sm border border-blue-200/50 dark:border-0 dark:border-white/10">
        ...
        <CardContent className='pt-3 px-5'>
          ...
          <div className="mt-3 pt-2 border-t border-gray-100 dark:border-gray-800">
            <div className="flex justify-between items-center">
              ...
              <span className={`text-sm font-medium ${contestDelta === 'N/A' ? 'text-gray-600 dark:text-gray-400' :
