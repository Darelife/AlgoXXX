        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          {loadingSuggestions ? (
            <div className="flex items-center justify-center py-8">
              <div className="w-6 h-6 border-2 border-t-orange-600 border-gray-300 rounded-full animate-spin"></div>
              <span className="ml-2 text-gray-700 dark:text-gray-300">Loading suggestions...</span>
            </div>
